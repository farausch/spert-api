...
def get_dep_dict():
    ...
    # DE
    return {'ROOT': 0, 'ac': 1, 'adc': 2, 'ag': 3, 'ams': 4, 'app': 5, 'avc': 6, 'cc': 7, 'cd': 8, 'cj' : 9, 'cm': 10, 'cp': 11, 'cvc': 12, 'da': 13, 'dep': 14, 'dm': 15, 'ep': 16, 'ju': 17, 'mnr': 18, 'mo': 19, 'ng': 20, 'nk': 21, 'nmc': 22, 'oa': 23, 'oc': 24, 'og': 25, 'op': 26, 'par': 27, 'pd': 28, 'pg': 29, 'ph': 30, 'pm': 31, 'pnc': 32, 'punct': 33, 'rc': 34, 're': 35, 'rs': 36, 'sb': 37, 'sbp': 38, 'svp': 39, 'uc': 40, 'vo': 41}